...
`Device`  
`device_id hostname ip_address device_type vendor firmware_version region status created_at updated_at`
...
`event_id device_id severity event_type message occurred_at resolved_at`
...
`config_id device_id config_version config_payload updated_by updated_at`
